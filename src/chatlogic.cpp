...
ChatLogic::~ChatLogic()
{
    ...
    // delete chatbot instance (No longer needed)
    //delete _chatBot;

    /* delete all nodes (Do not need this if using smart pointers)
    ...
    */
    ...
    /* delete all edges (Do not need this if using unique_smart pointers)
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            //_edges.push_back(edge.get()); No longer needed when using unique_ptr
